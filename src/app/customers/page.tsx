          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {caseStudies.map((study) => (
              <Link
                ...
                className={`group flex flex-col gap-6 rounded-technical border border-border bg-surface p-8 transition-colors ${EASE_FAST} hover:border-border-strong hover:bg-surface-hover`}
              >
        ...
        <Container className="flex flex-col gap-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {customers.map((customer) => (
              <div
                key={customer.name}
                className="flex flex-col gap-1.5 rounded-technical border border-border bg-surface p-6"
              >
